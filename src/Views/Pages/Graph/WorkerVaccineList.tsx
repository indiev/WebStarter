  ...
  cellRenderer: TableCellRenderer = ({ cellData, columnIndex }) => {
    ...
    return (
      ...
      >
        ...
        {columns[columnIndex].dataKey === 'completed' &&
          (cellData ? (
...
type Sample = [string, boolean, string, string, string];

const sample: readonly Sample[] = [
  ['김민준', true, '2021.09.21', '', ''],
  ['김서준', false, '2021.09.19', '2021.10.22', '2021.12.08'],
  ['김예준', true, '2021.09.20', '', ''],
  ['이도윤', false, '2021.09.18', '2021.10.22', ''],
  ['이시우', true, '2021.09.15', '2021.10.22', ''],
  ['장주원', true, '2021.09.21', '', ''],
  ['장하준', false, '2021.09.19', '2021.10.22', '2021.12.08'],
  ['김서연', true, '2021.09.20', '', ''],
  ['김서윤', false, '2021.09.18', '2021.10.22', ''],
  ['이지우', true, '2021.09.15', '2021.10.22', ''],
  ['이서현', true, '2021.09.21', '', ''],
  ['장민서', false, '2021.09.19', '2021.10.22', '2021.12.08'],
  ['장하은', true, '2021.09.20', '', ''],
  ['박지후', false, '2021.09.18', '2021.10.22', ''],
  ['박지호', true, '2021.09.15', '2021.10.22', ''],
  ['박준서', true, '2021.09.21', '', ''],
  ['박하윤', false, '2021.09.19', '2021.10.22', '2021.12.08'],
  ['박윤서', true, '2021.09.20', '', ''],
  ['최현우', false, '2021.09.18', '2021.10.22', ''],
  ['최도현', true, '2021.09.15', '2021.10.22', ''],
  ['최지훈', true, '2021.09.21', '', ''],
  ['최채원', false, '2021.09.19', '2021.10.22', '2021.12.08'],
  ['최지민', true, '2021.09.20', '', ''],
...
export default function ReactVirtualizedTable() {
  ...
  const { workers, updateVaccine } = useWorkerContext();
